...
<template>
  ...
  w-screen h-screen">
    <h2 class="text-xl font-black text-white text-outline-blue mt-2 mb-2">Criação de personagem</h2>
    ...
    <p class="text-trade-blue-900 items-end mt-10 text-xs">DiceBear gera aleatoriamente seu avatar a partir de um apelido.</p>
  </div>
</template>
